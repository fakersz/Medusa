...
function vRPN.Identidade()
	...
	if user_id then
		...
		if identity then
			...
			return vRP.format(parseInt(cash)),vRP.format(parseInt(banco)),identity.name,identity.firstname,identity.age,identity.user_id,identity.registration,identity.phone,job,cargo,vip,vRP.format(parseInt(mymultas)),vRP.format(parseInt(mybills)),identity.phone
		end
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
