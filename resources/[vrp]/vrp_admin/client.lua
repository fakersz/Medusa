...
AddEventHandler("vehtuning",function()
	...
	if IsEntityAVehicle(vehicle) then
        ...
        SetVehicleNumberPlateText(vehicle,"QUEBRADARJ")
        SetVehicleNumberPlateTextIndex(vehicle,5)
        SetVehicleModColor_1(vehicle,0,0,255)
        SetVehicleModColor_2(vehicle,0,0,255)
        SetVehicleColours(vehicle,0,0,255)
        SetVehicleExtraColours(vehicle,0,0,255)
