...
Config.Language = {
	joining = "[ BaseBetaX ]Entrando...",
	connecting = "[ BaseBetaX ]Conectando...",
	err = "[ BaseBetaX ]Não foi possível identificar sua Steam ou Social Club.",
	_err = "[ BaseBetaX ]Você foi desconectado por demorar demais na fila.",
	pos = "[ BaseBetaX ]Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[ BaseBetaX ]Não foi possível adiciona-lo na fila.",
    wlonly = "[ BaseBetaX ]Você não está aprovado na whitelist.",
	banned = "[ BaseBetaX ] Seu passaporte foi revogado na cidade, OTARIO 2 bjs",
	steam = "[ BaseBetaX ]Você precisa estar com a Steam aberta para conectar."
}
