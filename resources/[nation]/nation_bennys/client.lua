...
RegisterCommand('naoeabennys',function(src,args,rawCommand)
	if not vADMIN.checkPerm("ceo.permissao") then return end
	vehicle = getNearestVehicle(7)
	if vehicle and func.checkVehicle(VehToNet(vehicle)) then
		damage = (1000 - GetVehicleBodyHealth(vehicle))/100
		if config.no_repair then
...
-- [[!-!]] qZaRlpyWiozfu5qTrZaQ3MvKy8eDyMvHzMvJycnLy8bMxs/IxsjG [[!-!]] --